...
- Resolve every conflict semantically. Read both sides and surrounding code, docs, tests, schemas, generated artifacts, and contracts; inspect 3–10 relevant prior commits when useful; and review related repositories in **fiducia-cloud** and relevant external organizations when behavior crosses boundaries.
...
- Link substantial work to Linear: https://linear.app/denman/project/githubcomfiducia-cloud-8fd5e1bec9d3
